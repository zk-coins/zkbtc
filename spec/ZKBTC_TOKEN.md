...
This gate **MUST NOT** make the gatekeeper a challenger-funder. The gatekeeper has no peg-out role (REQ-4).
...
*End of design specification. No code. Not a production launch until the §4.6A REQ-4 gates and §4.6B maturity/integration gates clear (two remaining gates: Plonky2→BitVM2 conversion and open-registration market instantiation); the verifier itself is mainnet-proven.*
