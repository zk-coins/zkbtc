...
- **Not production-ready.** No implementation code exists, and two gates (predicate conversion, open-registration market) plus the REQ-4 gates must clear first. There is no external-audit gate.
